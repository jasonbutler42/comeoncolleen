...
<!-- You can start editing here. -->
  <?php if ( have_comments() ) : ?>
    ...
    <div class="comment-pagination">
      <div class="alignleft"><?php previous_comments_link( __( 'Older comments', 'adelle-theme' ) ) ?></div>
      <div class="alignright"><?php next_comments_link( __( 'Newer comments', 'adelle-theme' ) ) ?></div>
    </div>
